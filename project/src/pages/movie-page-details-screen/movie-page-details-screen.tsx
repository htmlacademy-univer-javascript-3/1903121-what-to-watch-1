...
type MoviePageDetailsScreenProps = {
  films: film[]
}

function MoviePageDetailsScreen({films}:MoviePageDetailsScreenProps) {
              ...
              <div className="film-card__text film-card__row">
                ...
                <div className="film-card__text-col">
                  <p className="film-card__details-item">
                    ...
                    <span className="film-card__details-value">{filmData.runTime}</span>
                  </p>
                  <p className="film-card__details-item">
